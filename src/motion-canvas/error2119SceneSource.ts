/**
 * SCRIPT COMPLETO DE MOTION CANVAS: ¿Por qué SUNAT rechaza tu comprobante?
 * Diagnóstico y Solución del Error 2119 de IGV / Esquema
 * 
 ...
 *    3. [PANEL DE CORRECCIÓN]: Tarjeta de diagnóstico y solución (Y: +450)
 * 
 * Listo para copiar y ejecutar en Motion Canvas (@motion-canvas/2d y @motion-canvas/core).
 */

export const ERROR_2119_SCENE_CODE = `import {makeScene2D} from '@motion-canvas/2d';
import {
  all,
  chain,
  createRef,
