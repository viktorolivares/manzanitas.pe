...
export default makeScene2D(function* (view) {
  ...
  yield* delay(2.4); // Duración Paso 1: 3.2s
  ...
  yield* delay(2.4); // Duración Paso 2: 3.2s
  ...
  yield* delay(2.6); // Duración Paso 7: 3.2s
  ...
  yield* delay(3.0); // Outro hold (Total: ~35 segundos a 1x)
});
`;
